		               ...
		               case 'select' :
		                ...
		                case 'media_gallery' :
	                		 ...
	                		 $out = '<div class="drop_meta_item">
	                            ...
	                            <input type="button" name="uploader" class="dsf_media_uploader_button" value="'.__('Add Images' , 'dsf').'">
	                            <div class="meta_description"><p>'.$field['desc'].'</p></div>
	                            </div><!-- end inner -->
	                            </div><!-- end single meta -->';
...
$post_fields = array(
                    ...
                    'fields' => array(
                    					array(
                                             'id' => 'ogg',
                                             'desc' => __('select here , make usre to select the audio post format .','dsf'),
