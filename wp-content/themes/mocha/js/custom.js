...
var footerParallax = mocha.footerParallax;
}
else
{
var Speed = 300;
...
var footerParallax = 'disable';
}



 /* -------------------------------------------------------------- 
 	Fix for widget count
  -------------------------------------------------------------- */
jQuery('.widget-content > ul li').each(function()
	{
			var wid = jQuery(this);
			if(wid.text().length !== wid.find('> a').text().length)
			{
					wid.addClass('list-width-count');
			}
...
alwaysShowHours: false
 ...
 /* -------------------------------------------------------------- 
 	Footer Parallex
  -------------------------------------------------------------- */
  if(footerParallax == 'enable' && jQuery(window).width() > 1280) {
  	  jQuery(window).load(function()
  	  	{
  	  			var footerH = jQuery('footer').height();
  	  			jQuery('body > section:last').css('margin-bottom' , footerH + 'px');
  	  	});
  }
...
/* recent works widgte */
jQuery('.works-wrapper a img').each(function()
	{
			...
			image.hover(function(){
					image.stop().animate({	
							width: '73px' , height : '73px' , marginLeft : '7px' , marginTop: '7px'
					} , {duration: 100});
			} , function(){
					image.stop().animate({	
							width: '87px' , height : '87px' , marginLeft: '0px' , marginTop : '0px'
					} , {duration: 100});
			});
	});
